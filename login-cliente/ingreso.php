        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <li><a class="dropdown-item" href="../HU20.html">Historial</a></li>
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="../new-pass-cliente/HU6C.php">Cambiar Contraseña</a></li>
              <li><a class="dropdown-item" href="../cliente-bye/HU21.php">Eliminar Cuenta</a></li>
            </ul>
            </li>
            <li class="nav-item">
              <form>
