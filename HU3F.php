...
<?php
  if(isset($_POST['crearcuenta'])){
    ...
    $consulta = ("INSERT INTO funcionarios(nombre,apellidopaterno,apellidomaterno,fechanacimiento,direccion,contraseña,nombreusuario,email,rut) VALUES('$_REQUEST[nombre]','$_REQUEST[apellidopaterno]','$_REQUEST[apellidomaterno]','$_REQUEST[fechanacimiento]','$_REQUEST[direccion]','$_REQUEST[contrasena]','$_REQUEST[nombreusuario]','$_REQUEST[email]','$_REQUEST[rut]')");
