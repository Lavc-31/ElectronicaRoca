      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item" href="login-func/HU9F.php">Agregar</a></li>
...
<center>
  <form class="mb-3" method="POST" style="margin-top:100px;">
    ...
    <div class="col-12" style= "margin-top:30px;">
      <form>
        <input type="submit" style="background-color:black;color:white;" value="Guardar" name="guardar"/>
      </form>
    </div>
  </form>
</center>
...
if(isset($_POST['guardar'])){
  ...
  $consulta = ("UPDATE funcionarios SET contraseña = '$nuevacontrasena' WHERE nombreusuario = '$nombreusuario';");
