        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <li><a class="dropdown-item" href="../HU7F.html">Historial</a></li>
              <li><a class="dropdown-item" href="../HU19.html">Destacados</a></li>
              <li><a class="dropdown-item" href="HU9F.php">Agregar</a></li>
              <li><a class="dropdown-item" href="">Modificar</a></li>
              <li><a class="dropdown-item" href="">Eliminar</a></li>
            </ul>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../new-pass-func/HU6F.php">Cambiar Contraseña</a>
            </li>
            <li class="nav-item">
              <form>
