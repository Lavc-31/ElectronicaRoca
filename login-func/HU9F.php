...
<body>
  ...
  <form class="row g-3" method="POST" style="margin-top:15px;" id="formulario" name="formulario">
    ...
    <div class="col-12">
      <form>
        <input type="submit" style="background-color:black;color:white;" value="Agregar producto" name="agregarproducto" />
      </form>
    </div>
  </center>
  </form>
...
<?php
  if(isset($_POST['agregarproducto'])){
    ...
    $consulta = ("INSERT INTO productos (id_categoria, id_administrador, id_funcionario, nombre, marca, precio, stock, descripcion, codigo) VALUES ('$_REQUEST[categorias]','$_REQUEST[administradores]','$_REQUEST[funcionarios]','$_REQUEST[nombre]','$_REQUEST[marca]','$_REQUEST[precio]','$_REQUEST[stock]','$_REQUEST[descripcion]','$_REQUEST[codigo]')");
